    ...
    useEffect(() => {
        const fetchBooks = async () => {
            ...
            try {
                ...
                const response = await fetch(`https://bookprojectjacobbackend.azurewebsites.net/Books/AllBooks?pageSize=${pageSize}&pageNum=${pageNum}&sort=${sort}${selectedCategories.length ? `&${categoryParams}` : ''}`);
